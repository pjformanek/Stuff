/*------------------------------------------------------------------------------
  	...
  	$Module:  	Header file for CC1101_Config.c
  	$Prefix:  	CC
  	$Language:	ANSI C
  	$Description:
...
/*------------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------------
 */
#define cCC1101_PA_TABLE_VAL   0xCD
...
/* Kevin's*/
#define HW_CC1101_ADDRS_STROBE_SYNC1        0x04        // Sync word, high byte
#define HW_CC1101_ADDRS_STROBE_SYNC0        0x05        // Sync word, low byte
...
// Strobe commands for KEVIN
#define HW_CC1101_ADDRS_STROBE_SRES         0x30        // Reset chip
#define HW_CC1101_ADDRS_STROBE_SFSTXON      0x31        // Enable/calibrate freq synthesizer
#define HW_CC1101_ADDRS_STROBE_SXOFF        0x32        // Turn off crystal oscillator
#define HW_CC1101_ADDRS_STROBE_SCAL         0x33        // Calibrate freq synthesizer & disable
#define HW_CC1101_ADDRS_STROBE_SRX          0x34        // Enable RX
#define HW_CC1101_ADDRS_STROBE_STX          0x35        // Enable TX
#define HW_CC1101_ADDRS_STROBE_SIDLE        0x36        // Exit RX / TX
#define HW_CC1101_ADDRS_STROBE_SAFC         0x37        // AFC adjustment of freq synthesizer
#define HW_CC1101_ADDRS_STROBE_SWOR         0x38        // Start automatic RX polling sequence
#define HW_CC1101_ADDRS_STROBE_SPWD         0x39        // Enter pwr down mode when CSn goes hi
#define HW_CC1101_ADDRS_STROBE_SFRX         0x3A        // Flush the RX FIFO buffer
#define HW_CC1101_ADDRS_STROBE_SFTX         0x3B        // Flush the TX FIFO buffer
#define HW_CC1101_ADDRS_STROBE_SWORRST      0x3C        // Reset real time clock
#define HW_CC1101_ADDRS_STROBE_SNOP         0x3D        // No operation.
...
u8 RFReceivePacket( u8 *pbRxBuffer, u8 bLength, u16 bTimeOutms );
