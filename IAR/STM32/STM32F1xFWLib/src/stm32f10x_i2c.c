...
* Return         : None
*******************************************************************************/
void I2C_SR1_AckBit( I2C_TypeDef* I2Cx, FunctionalState NewState )
{
  /* Check the parameters */
  assert_param(IS_I2C_ALL_PERIPH(I2Cx));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  {
    /* Enable the selected I2C peripheral */
    I2Cx->SR1 |= CR1_ACK_Set;
  }
  else
  {
    /* Disable the selected I2C peripheral */
    I2Cx->SR1 &= CR1_ACK_Reset;
  }
}
...
u8 testss(I2C_TypeDef* I2Cx, u8* pBuffer,  u32 NumByteToWrite, u8 SlaveAddress )
{  
  u16 Timeout = 0xFFFF;
  u8 Address = 0xA0;
...
void ClearSrRegs( I2C_TypeDef* I2Cx )
{
  I2Cx->SR1 = 0x00;
  I2Cx->SR2 = 0x00;
}
