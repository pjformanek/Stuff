...
u8 GPIO_ReadInputDataBit(GPIO_TypeDef* GPIOx, u16 GPIO_Pin)
{
  ...
  if ((GPIOx->IDR & GPIO_Pin) != (u32)ecGPIO_BitAction_CLEAR)
  {
    bitstatus = (u8)ecGPIO_BitAction_SET;
  }
  else
  {
    bitstatus = (u8)ecGPIO_BitAction_CLEAR;
  }
  return bitstatus;
}
...
u8 GPIO_ReadOutputDataBit(GPIO_TypeDef* GPIOx, u16 GPIO_Pin)
{
  ...
  if ((GPIOx->ODR & GPIO_Pin) != (u32)ecGPIO_BitAction_CLEAR)
  {
    bitstatus = (u8)ecGPIO_BitAction_SET;
  }
  else
...
* Return         : None
*******************************************************************************/
void GPIO_ClearBits(GPIO_TypeDef* GPIOx, u16 GPIO_Pin)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
  assert_param(IS_GPIO_PIN(GPIO_Pin));
...
*                    This parameter can be one of the teGPIO_BitAction enum values:
*                       - ecGPIO_BitAction_CLEAR: to clear the port pin
*                       - ecGPIO_BitAction_SET: to set the port pin
* Output         : None
* Return         : None
*******************************************************************************/
void GPIO_WriteBit(GPIO_TypeDef* GPIOx, u16 GPIO_Pin, teGPIO_BitAction BitVal)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
  assert_param(IS_GET_GPIO_PIN(GPIO_Pin));
  ...
  if (BitVal != ecGPIO_BitAction_CLEAR)
  {
    GPIOx->BSRR = GPIO_Pin;
  }
  else
