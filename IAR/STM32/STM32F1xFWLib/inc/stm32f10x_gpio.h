...
/* ecGPIO_BitAction_SET and ecGPIO_BitAction_CLEAR enumeration -----------------------------------------*/
typedef enum
{
	ecGPIO_BitAction_CLEAR = 0,
	ecGPIO_BitAction_SET
} teGPIO_BitAction;
#define IS_GPIO_BIT_ACTION(ACTION) (((ACTION) == ecGPIO_BitAction_CLEAR) || ((ACTION) == ecGPIO_BitAction_SET))
